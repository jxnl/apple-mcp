...
- Maps:
  ...
  **Maps Tool Usage Examples:**
  ...
  mcp__maps({
    ...
    fromAddress: "Trafalgar Square, London",
    toAddress: "Barbican Centre, London",
    transportType: "transit" // Optional: "driving" (default), "walking", or "transit"
  })
  ...
  mcp__maps({
    ...
    guideName: "London Favorites"
  })
  
  // Add a location to a guide
  mcp__maps({
